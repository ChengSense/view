React.createElement("div", { "id": `grid`, "class": `k-grid k-widget k-display-block`},
  ...
  React.createElement("div", { "class": `k-grid-content k-auto-scrollable`, "style": `height: 643px;`, "@scroll": `scroll`},
        ...
        new Render().forEach(list, (item, id) => [
          React.createElement("tr", { "class": `${id % 2 ? 'k-alt' : ''}`},
            ...
            React.createElement("td", {},
              ...
              React.createElement("span", { "class": `k-button k-button-icontext k-grid-delete`, "@click": `del(id)`},
